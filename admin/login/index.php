				...
				<div class="col-md-12">
					<div class="card-body">
						...
						<div class="form-group mb-3">
							<input type="text" class="form-control" id="Email" placeholder="Masukan Username" name="username">
						</div>
						...
						<p class="mb-0 text-muted">Don’t have an account? <a href="../singup/index.php" class="f-w-400">Signup</a></p>
					</div>
				</div>
			</div>
			</form>
