            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header">
                        <a href="?page=kontak/tambah" class="btn btn-primary">tambah data</a>
                    </div>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $item ['judul']?></td>
                                        <td><?= $item ['isi']?></td>
                                        <td><a href="?page=kontak/ubah&id_kontak=<?php echo $item["id_kontak"];?>" class="btn btn-success">ubah</a>
