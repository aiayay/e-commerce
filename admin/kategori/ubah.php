...
$getid = $_GET['id_kategori'];

$search = mysqli_query($koneksi,"SELECT * FROM kategori where id_kategori ='$getid'");
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nama_kategori"
                                            placeholder="Masukan Nama Kategori" value="<?php echo $item ['nama_kategori'];?>">
                                    </div>
