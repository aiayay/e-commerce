		...
		<div class="navbar-wrapper  ">
			<div class="navbar-content scroll-div " >
				...
				<div class="">
					<div class="main-menu-header">
						...
						<div class="user-details">
							...
							<div id="more-details">Programer</div>
						</div>
					</div>
				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item">
					    <a href="?page=home/index" class="nav-link "><span class="pcoded-micon">
							<i class="feather icon-home"></i></span>
							<span class="pcoded-mtext">Dashboard</span></a>
					</li>
					<li class="nav-item">
					    <a href="?page=kategori/index" class="nav-link "><span class="pcoded-micon">
							<i class="feather icon-list"></i></span>
							<span class="pcoded-mtext">Kategori</span></a>
					</li>
					<li class="nav-item">
					    <a href="?page=produk/index" class="nav-link "><span class="pcoded-micon"><i class="feather icon-map">
						</i></span><span class="pcoded-mtext">produk</span></a>
					</li>
					<!-- <li class="nav-item">
					    <a href="?page=armada/index" class="nav-link "><span class="pcoded-micon"><i class="feather icon-list">
						</i></span><span class="pcoded-mtext">armada</span></a>
					</li>
					<li class="nav-item">
					    <a href="?page=kontak/index" class="nav-link "><span class="pcoded-micon"><i class="feather icon-phone">
						</i></span><span class="pcoded-mtext">kontak</span></a>
					</li>
					<li class="nav-item">
					    <a href="?page=tim/index" class="nav-link "><span class="pcoded-micon"><i class="feather icon-users">
						</i></span><span class="pcoded-mtext">tim kami</span></a>
					</li> -->
					<li class="nav-item">
					    <a href="?page=user/index" class="nav-link "><span class="pcoded-micon"><i class="feather icon-user">
						</i></span><span class="pcoded-mtext">user</span></a>
					</li>
					<li class="nav-item">
					    <a href="?page=pesanan/index" class="nav-link "><span class="pcoded-micon"><i class="feather icon-user">
						</i></span><span class="pcoded-mtext">Pesanan</span></a>
					</li>
				</ul>
						...
						<li>
							<div class="dropdown drp-user">
								...
								<div class="dropdown-menu dropdown-menu-right profile-notification">
									<div class="pro-head">
										<img src="assets/images/user/<?= $_SESSION['foto'] ?>" class="img-radius" alt="User-Profile-Image">
										<span><?= $_SESSION['nama_lengkap'] ?></span>
